...
date: '2023-01-08'
tags: ['ai', 'git', 'how-to']
summary: 'How I used Mem to create a blog post.'
draft: false
layout: PostBanner
images: ['/static/images/ai-blogging/post-cover.jpg']
---
...
![Want me to write you a blog post?](/static/images/ai-blogging/SCR-20230105-wn7.png)
...
central place so as to achieve the "_Mind Like Water_" state that results from not having to worry
...
![The Mem I was working on](/static/images/ai-blogging/SCR-20230105-wlf.png)

As I was highlighting content to format it, I noticed Mem's _Smart Edit_ button on the popup menu
